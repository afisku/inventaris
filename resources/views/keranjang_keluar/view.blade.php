                ...
                <tbody>
                    @foreach ($keluar as $i => $u)
                        <tr class="data-row">
                            ...
                            <td>
                                <div class="row">
                                    <a href="/keranjang_keluar/edit/{{ $u->id_keluar }}"
                                        class="btn btn-primary btn-sm ml-2">Edit</a>
                                    <a href="javascript:void(0)" id="hapus" data-id="{{ $u->id_keluar }}"
